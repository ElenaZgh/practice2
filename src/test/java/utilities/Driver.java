...
public class Driver {
    ...
    public static WebDriver getDriver() {
        System.setProperty("webdriver.chrome.driver",
                "/Users/elenazghibarta/Desktop/CodeWise/SeleniumFirstProject/src/test/drivers/chromedriver");
        ...
        int pageWait = Integer.parseInt(Config.getProperty("pageLoadLimeOut"));
